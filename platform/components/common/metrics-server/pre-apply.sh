...
# runnable standalone (4 levels: metrics-server to common to components to platform to repo).
...
# stays at HTTP 500 "metric-storage-ready: no metrics to serve", so every HPA
