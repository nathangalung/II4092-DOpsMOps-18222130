...
\centering
\footnotesize
\begin{tabular}{@{}p{3.0cm}p{5.4cm}p{1.5cm}p{5.6cm}@{}}
\toprule
\textbf{Layer} & \textbf{Recurring services named by the sources} & \textbf{Sources} & \textbf{Selected open source components} \\
\midrule
Orchestration and Infrastructure & model training infrastructure, infrastructure and supporting services & \cite{kreuzberger2023mlops}, \cite{najafabadi2024analysis}, \cite{googlecloud2024mlops} & k3s, HPA, VPA recommender, KEDA, Kueue, cert-manager \\
...
Observability & monitoring component, model monitoring, data monitoring & \cite{kreuzberger2023mlops}, \cite{amershi2019software}, \cite{najafabadi2024analysis}, \cite{munappy2020adhoc} & Prometheus, Loki, Grafana Tempo, Grafana, OpenTelemetry, Evidently, OpenCost \\
