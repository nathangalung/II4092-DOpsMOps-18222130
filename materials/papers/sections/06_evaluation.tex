...
Every scenario was run manually, outside the reconciliation path, and the load generator ran from a separate namespace, so that measurement did not disturb the pipeline under test. Table~\ref{tab:verification} gives the distribution. The full requirement list appears in the accompanying project report.
