...
%\input{frontmatter/10_Daftar_Persamaan.tex} % Dinonaktifkan: tidak ada persamaan bernomor pada Bab 1-5.
%\input{frontmatter/11_Daftar_Algoritma.tex} % Dinonaktifkan: tidak ada algoritma pada Bab 1-5.
