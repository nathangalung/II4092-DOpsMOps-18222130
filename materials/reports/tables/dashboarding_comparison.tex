\begin{table}[H]
\centering
\caption{Evaluasi Alternatif \textit{Business Intelligence} dan \textit{Dashboarding}}
...
\hline
\multicolumn{1}{|>{\centering\arraybackslash}m{2.9cm}|}{\textbf{\textit{BI Tool}}} & \textbf{Kema\-tangan} & \textbf{Konektor SQL} & \textbf{Multi-Tenant K8s} & \textbf{Komu\-nitas} & \textbf{Lisensi (Yayasan)} & \textbf{Total} \\
\hline
