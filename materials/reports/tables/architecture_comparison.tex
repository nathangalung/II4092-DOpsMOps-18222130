...
RBAC terintegrasi, \textit{audit trail} komprehensif, dan pengecekan \textit{compliance} yang terotomatisasi. Dex sebagai \textit{identity provider} OIDC memusatkan identitas, oauth2-proxy menegakkan autentikasi pada antarmuka aplikasi, Kyverno menegakkan kebijakan admisi pada klaster, OpenBao mengelola \textit{secrets}, sementara Falco dan Trivy Operator memantau ancaman \textit{runtime} dan kerentanan \textit{image}. &
