...
\begin{longtable}{|m{2cm}|m{2.5cm}|m{2.5cm}|m{2.8cm}|m{2cm}|}
...
\multicolumn{1}{>{\centering\arraybackslash}m{3cm}|}{\textbf{Manfaat yang Diharapkan}} &
...
Jeda deteksi \textit{drift} dapat dipersingkat sehingga pelatihan ulang dapat dijadwalkan lebih tepat waktu untuk menjaga kinerja model. &
...
\textit{Observability} mencakup metrik ML, dasbor kinerja model, dan \textit{alert} berbasis indikator \textit{drift}. Prometheus dan Grafana menjadi inti, OpenTelemetry mengalirkan log dan \textit{trace} ke Loki dan Grafana Tempo, sementara Alertmanager mengonsolidasikan \textit{alert} ke berbagai kanal notifikasi. &
