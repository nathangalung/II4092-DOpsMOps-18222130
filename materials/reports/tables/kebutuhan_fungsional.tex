...
\hline
KF-11 & Pemrosesan \textit{Batch} dan \textit{Stream} & Sistem mendukung \textit{batch processing} untuk analisis dan rekayasa fitur historis serta \textit{stream processing} untuk komputasi fitur \textit{real-time}, di mana keduanya terhubung dengan \textit{feature store} sehingga definisi fitur tetap konsisten. & T-4 \\
\hline
...
\hline
KF-13 & API dan SDK Terpadu & Sistem menyediakan kumpulan SDK Python yang seragam (Feast, MLflow, Kubeflow Pipelines, dbt, dan klien KServe v2 \textit{inference}) sebagai antarmuka standar untuk berinteraksi dengan seluruh komponen, sehingga kompleksitas integrasi menurun dan pola pemakaian menjadi konsisten. & T-1 \\
\hline
