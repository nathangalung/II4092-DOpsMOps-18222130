...
\hline
KF-11 & Pemrosesan \textit{Batch} dan \textit{Stream} & Sistem mendukung \textit{batch processing} untuk analisis dan rekayasa fitur historis serta \textit{stream processing} untuk komputasi fitur \textit{real-time}, dan keduanya terhubung dengan \textit{feature store} sehingga definisi fitur tetap konsisten. & T-4 \\
\hline
