...
\begin{longtable}{|>{\raggedright\arraybackslash}m{2.5cm}|>{\raggedright\arraybackslash}m{5.6cm}|>{\raggedright\arraybackslash}m{4.4cm}|}
\caption{Rincian Karakteristik dan Kebutuhan Tiap Tahap Model Evolusi DataOps}
\label{tab:dataops_stage_legend} \\
\hline
\textbf{Tahap} & \textbf{Karakteristik} & \textbf{Kebutuhan Kunci} \\
\hline
\endfirsthead
\hline
\textbf{Tahap} & \textbf{Karakteristik} & \textbf{Kebutuhan Kunci} \\
