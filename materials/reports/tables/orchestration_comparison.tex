...
\hline
\multicolumn{1}{|>{\centering\arraybackslash}m{2.9cm}|}{\textbf{Orkestrasi ML}} & \textbf{Kema\-tangan} & \textbf{K8s-Native} & \textbf{\textit{Pipeline} ML} & \textbf{Komu\-nitas} & \textbf{Lisensi (Yayasan)} & \textbf{Total} \\
\hline
