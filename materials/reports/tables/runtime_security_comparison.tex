...
\hline
\multicolumn{1}{|>{\centering\arraybackslash}m{2.9cm}|}{\textbf{\textit{Runtime Security}}} & \textbf{Kema\-tangan} & \textbf{Cakupan eBPF/\allowbreak Kernel} & \textbf{Aturan \textit{Built-in}} & \textbf{Komu\-nitas} & \textbf{Lisensi (Yayasan)} & \textbf{Total} \\
\hline
