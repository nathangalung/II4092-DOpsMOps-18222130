\begin{table}[!htb]
\centering
\caption{Ilustrasi Biaya Infrastruktur dan Tenaga Kerja Tiga Tahun per 16 Juni 2026}
...
\hline
\textbf{Komponen Biaya} & \textbf{Skenario A (VPS)} & \textbf{Skenario B (GKE)} & \textbf{Skenario C (Terkelola)} \\
\hline
