...
\begin{table}[H]
\centering
\caption{Pemetaan \textit{Layer} Platform ke Komponen Mayoritas}
\label{tab:layanan_industri}
\footnotesize
\setlength{\tabcolsep}{3pt}
\begin{tabular}{|>{\raggedright\arraybackslash}m{3.4cm}|>{\raggedright\arraybackslash}m{6.35cm}|>{\raggedright\arraybackslash}m{3.5cm}|}
\hline
\centering\arraybackslash\textbf{\textit{Layer}} & \centering\arraybackslash\textbf{Layanan dan Komponen Mayoritas} & \centering\arraybackslash\textbf{Sumber} \\
\hline
...
\hline
\textit{Security Layer} & akses terkendali, kepatuhan privasi dan keamanan data, \textit{API gateway} & \autocite{munappy2020adhoc,rella2022mlops,najafabadi2024analysis} \\
\hline
\end{tabular}
\end{table}
