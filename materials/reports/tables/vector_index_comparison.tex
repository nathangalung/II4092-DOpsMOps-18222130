\begin{table}[!htb]
\centering
\caption{Evaluasi Alternatif \textit{Vector Index} \textit{Open-Source}}
...
\hline
\multicolumn{1}{|>{\centering\arraybackslash}m{2.9cm}|}{\textbf{\textit{Vector Index}}} & \textbf{Kema\-tangan} & \textbf{Latensi Rendah} & \textbf{Komu\-nitas} & \textbf{Opera\-bilitas K8s} & \textbf{Lisensi (Yayasan)} & \textbf{Total} \\
\hline
