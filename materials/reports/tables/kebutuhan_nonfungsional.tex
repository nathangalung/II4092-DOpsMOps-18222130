...
\hline
KNF-12 & Kemudahan Pemeliharaan & Sistem harus mudah dipelihara, dengan struktur kode dan manifes yang jelas, \textit{pipeline} CI yang otomatis pada Tekton, serta \textit{deployment} deklaratif dari sumber rujukan tunggal pada Gitea melalui Argo CD. & Setiap komponen dapat direkonsiliasi ulang dari \textit{repository} Gitea tanpa intervensi manual, dan perubahan ditolak otomatis oleh \textit{pull request review} dan \textit{policy} Kyverno bila tidak sesuai konvensi & T-1 \\
\hline
\end{longtable}
}