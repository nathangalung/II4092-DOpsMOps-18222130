...
\hline
KNF-09 & Kemudahan Penggunaan & Antarmuka sistem harus intuitif dan didukung dokumentasi yang ringkas, sehingga pengguna baru dapat mengadopsi sistem dengan kurva belajar yang wajar melalui antarmuka web Argo CD, Argo Workflows, Kubeflow, MLflow, DataHub, dan Grafana yang terintegrasi dalam \textit{single sign on} dex. & Setiap antarmuka pengembang memiliki dokumentasi pengguna dan dapat diakses melalui SSO dex dan oauth2-proxy tanpa konfigurasi tambahan per layanan \\
\hline
