...
\begin{table}[!htb]
\centering
\caption{Pemetaan Sembilan \textit{Layer} ke Komponen Terpasang dan \textit{Namespace}}
...
\hline
\textbf{\textit{Layer}} & \textbf{Komponen Terpasang} & \textbf{\textit{Namespace}} \\
\hline
...
\hline
\textit{Platform Security} & Istio, APISIX, Dex, oauth2-proxy, SpiceDB, OpenBao, ESO, Kyverno, Falco, Trivy, Velero, Chaos Mesh & \texttt{security}, \texttt{istio-system}, \texttt{external-secrets}, \texttt{velero} \\
\hline
\end{tabular}
\end{table}
