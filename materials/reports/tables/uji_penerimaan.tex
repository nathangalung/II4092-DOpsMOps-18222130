...
\hline
SK-F-07 & KF-07 & Menerapkan injeksi \textit{drift} terkendali pada satu fitur dari data nyata, lalu mengamati detektor \textit{drift} dan \textit{CronWorkflow retrain-on-drift}. & \textit{Drift} terdeteksi saat ambang PSI atau KS terlampaui dan \textit{pipeline} pelatihan ulang terpicu otomatis. \\
\hline
