% Tabel orientasi peran pengguna pada IV.1 (Gambaran Umum). Sesuai aturan
% bebas-alat sebelum IV.3 (sec:pemilihan-tools), kolom memetakan peran ke
% ANTARMUKA generik dan LAYER platform (tab:layanan_industri), bukan ke nama
% tool; perwujudan alat tiap layer dibahas mulai IV.3.
\begin{table}[!htb]
\centering
