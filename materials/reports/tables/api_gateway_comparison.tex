...
\hline
\multicolumn{1}{|>{\centering\arraybackslash}m{2.9cm}|}{\textbf{\textit{API Gateway}}} & \textbf{Kema\-tangan} & \textbf{Lisensi \textit{Open}} & \textbf{Opera\-bilitas K8s} & \textbf{\textit{Plugin}/\allowbreak Ekstensi} & \textbf{Lisensi (Yayasan)} & \textbf{Total} \\
\hline
