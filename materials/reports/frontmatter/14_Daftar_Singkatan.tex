...
CR & \textit{Custom Resource}, instans objek dari sebuah CRD pada Kubernetes. & Bab~\ref{chap:implementasi} \\
...
DAG & \textit{Directed Acyclic Graph}, graf berarah tanpa siklus untuk menyusun urutan tugas pada \textit{orchestrator}. & Bab~\ref{chap:implementasi} \\
