...
\begin{enumerate}
    ...
    \item \textbf{Ketergantungan pada kelengkapan jalur data}

    Sebagian skenario bergantung pada kelengkapan jalur data \textit{use case} sehingga penilaian kebenaran nilai fitur dilakukan setelah jalur ingestasi sampai \textit{gold} terisi penuh.
\end{enumerate}
