...
Evaluasi T-4 menilai apakah layanan fitur \textit{dual-store} menyajikan fitur tabular, fitur agregat, dan fitur vektor dengan kontrak yang konsisten antara pelatihan dan penyajian. Skenario SK-F-02 memeriksa penyajian fitur \textit{online} non-\textit{null} pada Valkey melalui \texttt{feast/}\allowbreak\texttt{online-serving-check.py} lalu membandingkannya dengan nilai \textit{offline} pada ClickHouse untuk membuktikan penyajian ganda KF-02, sedangkan SK-F-04 menjalankan beban pencarian vektor pada Qdrant melalui \texttt{load/}\allowbreak\texttt{vector-search-latency.js} untuk membuktikan dukungan \textit{vector embeddings} KF-04. Skenario SK-F-11 membandingkan fitur hasil \textit{batch} dan hasil \textit{stream} pada indikator yang sama melalui \texttt{parity/}\allowbreak\texttt{parity-check.sh} untuk membuktikan pemrosesan ganda KF-11 dengan definisi fitur yang konsisten. Ketiga skenario tersebut menelusuri kontrak fitur dari sisi kebenaran nilai sebelum beban tinggi diterapkan.
