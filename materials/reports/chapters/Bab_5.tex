...
Ketiga kasus khusus ditangani sesuai rancangan pada Subbab~\ref{subsec:kasus-khusus}. Ambang PSI dan KS beserta jendela \textit{lookback} dideklarasikan pada \texttt{ConfigMap} \texttt{drift-thresholds} di \textit{namespace} \texttt{model-lifecycle} sehingga perubahannya cukup melalui \textit{commit} Git tanpa membangun ulang \textit{image}. Setiap eksekusi menuliskan \texttt{checksum} versi konfigurasi tersebut sehingga nilai ambang yang berlaku tetap dapat dirunut saat audit. Nilai parameter yang aktif dapat dibaca langsung dari manifes sehingga audit kebijakan tidak memerlukan akses ke sistem lain. Pemenuhan KF-07 diverifikasi melalui skenario evaluasi pada Bab~\ref{chap:evaluasi}.
