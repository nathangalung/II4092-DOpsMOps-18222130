...
# Prosedur SDK Feast: experiments/feast/README.md. Cek substrat dulu; bila user
# default in-pod bersandi, ambil kredensial admin dari Secret (nilai tidak
# dicetak, hanya diekspor ke env subshell — kunci: CLICKHOUSE_USER/PASSWORD).
...
# SK-F-02 (KF-02) — penyajian ganda: online non-null (Feast) + substrat offline (ClickHouse).
...
# substrat offline (ekspor CLICKHOUSE_USER/PASSWORD spt. Listing T-3 bila bersandi):
experiments/etl/data-landed-check.sh
...
# (kredensial ClickHouse: ekspor spt. Listing T-3 bila user default bersandi).
experiments/etl/data-landed-check.sh
