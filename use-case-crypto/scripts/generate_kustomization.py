...
Usage:
    ...
    uv run scripts/generate_kustomization.py --dry-run
"""
...
def generate_kustomization(services: dict, dry_run: bool = False) -> str:
    ...
    lines.append("# Generated by: uv run scripts/generate_kustomization.py")
    lines.append("# Based on: config/services.yaml enabled flags")
    lines.append("#")
    lines.append("# To regenerate: make usecase-crypto-generate-kustomization")
    lines.append(
        "# ============================================================================="
    )
    lines.append("")
